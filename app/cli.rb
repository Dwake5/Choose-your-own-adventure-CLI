...
{
id: 5,
description: 'You arrive at school eager and ready to learn. You notice that everyone else is seated.
              Looking around people have split into two distinct groups, who do you want to sit with?',
choices: [
...
{
id: 7,
description: 'You sit down in the cool group, they continue to laugh and joke along with you, you waste a few hours screwing around, but make some friends.
              You hear labs are coming up soon, do you want a coffe first?',
choices: [
  { choice: 8, text: 'Coffee, coffee, coffee!'},
  { choice: 9, text: 'Straight to the labs'},
],
...
{
id: 8,
description: "The coffee here taste's great, better than that crap you get from 'insert popular coffee franchise, you know the one' you eagerly take on the labs",
choices: [
